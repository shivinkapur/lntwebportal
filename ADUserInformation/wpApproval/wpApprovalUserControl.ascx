...
<asp:GridView ID="grdAppPage" runat="server" AllowPaging="True" AllowSorting="false"
    AutoGenerateColumns="False" Width="400px" CellPadding="4" DataKeyNames="ID" EnableModelValidation="True"
    ForeColor="#333333" GridLines="None" EmptyDataText=" There are no more items to show. Please click on done to proceed. ">
    <Columns>
        ...
        <asp:BoundField DataField="apNames" HeaderText="Requestee Names" HeaderStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="apModule" HeaderText="Module Name" HeaderStyle-HorizontalAlign="Left" />
    </Columns>
...
<asp:Button ID="btnReject" runat="server" Text="Reject" OnClick="btnReject_Click"
    Width="100px" />
<asp:Button ID="btnDone" runat="server" Text="Done" OnClick="btnDone_Click" Width="100px" />
